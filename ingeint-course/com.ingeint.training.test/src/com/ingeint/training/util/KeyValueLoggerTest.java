...
package com.ingeint.training.util;

import static com.ingeint.training.test.util.RandomTestUtil.*;
import static com.ingeint.training.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.ingeint.training.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.ingeint.training.util\"");
	}
