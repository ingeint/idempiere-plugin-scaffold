...
- New callout
  - Name: CName
  - Package: com.ingeint.training.callout
  - Example: com.ingeint.training.callout.CStringFormat

- New process
  - Name: PName
  - Package: com.ingeint.training.process
  - Example: com.ingeint.training.process.PGenerateWithholding

- New form
  - Name: FName
  - Package: com.ingeint.training.form
  - Example: com.ingeint.training.form.FMultiPayment

- New event
  - Name: EName
  - Package: com.ingeint.training.event
  - Example: com.ingeint.training.event.EAfterCompleteInvoice

- New model (extends class X)
  - Name: MName
  - Package: com.ingeint.training.model
  - Example: com.ingeint.training.model.MTableExample

## Folder estructure

```text
    com.ingeint.training
        |_.settings
...
- New callout
  - Create callout in package `com.ingeint.training.callout`, extends from `CustomCallout`
  - Annotate it with the `@Callout` annotation at class level

- New process
  - Create process in package `com.ingeint.training.process`, extends from `CustomProcess`
  - Annotate it with the `@Process` annotation at class level

- New form
  - Create form in package `com.ingeint.training.form`, extends from `CustomForm`
  - Annotate it with the `@Form` annotation at class level

- New event
  - Create event in package `com.ingeint.training.event`, extends from `CustomEvent`
  - Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
  - Create model in package `com.ingeint.training.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
