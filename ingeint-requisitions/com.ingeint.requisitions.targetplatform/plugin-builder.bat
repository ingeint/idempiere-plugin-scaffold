...
call mvn validate -Didempiere.target=com.ingeint.requisitions.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=com.ingeint.requisitions.p2.targetplatform %DEBUG_MODE%
