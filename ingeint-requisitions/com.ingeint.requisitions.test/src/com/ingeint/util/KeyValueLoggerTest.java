 ...
 *
 * Copyright (C) 2021 INGEINT CA <https://www.ingeint.com> and contributors (see README.md file).
 */

package com.ingeint.util;

import static com.ingeint.test.util.RandomTestUtil.*;
import static com.ingeint.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.ingeint.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.ingeint.util\"");
	}
