...
call mvn validate -Didempiere.target=${plugin.symbolic.name}.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=${plugin.symbolic.name}.p2.targetplatform %DEBUG_MODE%
