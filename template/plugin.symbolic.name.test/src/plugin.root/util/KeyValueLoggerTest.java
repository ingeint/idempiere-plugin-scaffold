...
import static ${plugin.root}.test.util.RandomTestUtil.getRandomBoolean;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomByte;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomChar;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomDouble;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomFloat;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomInt;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomLong;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomShort;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomString;
import static ${plugin.root}.test.util.RandomTestUtil.getRandomUUID;
import static ${plugin.root}.test.util.ReflectionTestUtil.getFieldValue;
import static ${plugin.root}.test.util.ReflectionTestUtil.setFieldValue;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verify(logger).info("class=\"{}\"", new Object[] { "${plugin.root}.util.KeyValueLogger" });
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verify(logger).info("package=\"{}\"", new Object[] { "${plugin.root}.util" });
	}
