...
package com.ingeint.test.v13.util;

import static com.ingeint.test.v13.test.util.RandomTestUtil.*;
import static com.ingeint.test.v13.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.ingeint.test.v13.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.ingeint.test.v13.util\"");
	}
