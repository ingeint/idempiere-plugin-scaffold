...
- New callout
  - Name: CName
  - Package: com.ingeint.test.v13.callout
  - Example: com.ingeint.test.v13.callout.CStringFormat

- New process
  - Name: PName
  - Package: com.ingeint.test.v13.process
  - Example: com.ingeint.test.v13.process.PGenerateWithholding

- New form
  - Name: FName
  - Package: com.ingeint.test.v13.form
  - Example: com.ingeint.test.v13.form.FMultiPayment

- New event
  - Name: EName
  - Package: com.ingeint.test.v13.event
  - Example: com.ingeint.test.v13.event.EAfterCompleteInvoice

- New model (extends class X)
  - Name: MName
  - Package: com.ingeint.test.v13.model
  - Example: com.ingeint.test.v13.model.MTableExample

## Folder estructure

```text
    com.ingeint.test.v13
        |_.settings
...
- New callout
  - Create callout in package `com.ingeint.test.v13.callout`, extends from `CustomCallout`
  - Annotate it with the `@Callout` annotation at class level

- New process
  - Create process in package `com.ingeint.test.v13.process`, extends from `CustomProcess`
  - Annotate it with the `@Process` annotation at class level

- New form
  - Create form in package `com.ingeint.test.v13.form`, extends from `CustomForm`
  - Annotate it with the `@Form` annotation at class level

- New event
  - Create event in package `com.ingeint.test.v13.event`, extends from `CustomEvent`
  - Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
  - Create model in package `com.ingeint.test.v13.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
